...

{
  ...
  const quiz = [
    ...
    {
      q:
        "What did the romans drop in wine to improve the health before drinking?",
      answers: [
        { answer: "Toast", img: "./img/toast.jpg" },
...

    {
      ...
      answers: [
        { answer: "Republic of Nauru", img: "./img/nauru.jpg" },
    ...
    },
    {
      ...
      answers: [
        { answer: "Portuguese", img: "./img/portugal.jpg" },
    ...
    },
    {
      ...
      answers: [
        { answer: "Samuel de champlain", img: "./img/samuel.jpg" },
  ...
  btn.addEventListener("click", () => {
    ...
    if (currentNum === quiz.length - 1) {
      ...
      scoreLabel.textContent = `Your Total score is ${score}! You answered ${goodAnswer} questions!`;
